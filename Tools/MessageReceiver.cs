...
namespace MouseNet.Tools
{
    ...
    /// <summary>
    /// Contains information about a <see cref="MessageReceiver"/> event.
    /// </summary>
    public class MessageStringEventArgs : EventArgs {
        /// <summary>
        /// The message received by the <see cref="MessageReceiver"/>.
        /// </summary>
        public string Message { get; }

        /// <inheritdoc />
        public MessageStringEventArgs(string message)
            {
            Message = message;
            }
    }
    ...
    public class MessageReceiver : IDisposable
    {
        ...
        public void StartReading()
            {
            Task.Factory.StartNew(ReadLoop, _ctSource.Token);
            }
        ...
        private void ReadLoop()
            ...
            using (var sr = new StreamReader(_pipeServer.Stream))
                while ((temp = sr.ReadLine()) != null)
                    InvokeMessageReceived(this, new MessageStringEventArgs(temp));
            }

        private void InvokeMessageReceived
            (object sender,
             MessageStringEventArgs args)
            {
        ...
        /// </summary>
        public event EventHandler<MessageStringEventArgs> MessageReceived;
